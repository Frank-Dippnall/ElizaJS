...
create table ElizaMemory (fact_id int auto_increment primary key, negotiator varchar(31) references ElizaAcquaintance(username), fact_date datetime, term1 varchar(127), operator varchar(15), term2 varchar(127));
